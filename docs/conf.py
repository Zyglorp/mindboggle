...
latex_documents = [
    (master_doc, 'Mindboggle.tex', 'Mindboggle Documentation',
     'Arno Klein', 'manual'),
]
...
man_pages = [
    (master_doc, 'mindboggle', 'Mindboggle Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Mindboggle', 'Mindboggle Documentation',
     author, 'Mindboggle', 'Automate human brain MR image labeling, feature extraction, and shape analysis.'),
]
