...
class DKTprotocol:
    ...
    right_cerebrum_noncortex_list = (
        ...
        + list(range(500, 509))
        + [2004]
        + list(range(4000, 4036))
        + [5002]
        + right_ventricle_list
    )
    medial_cerebrum_noncortex_list = (
        medial_ventricle_list + [192] + list(range(250, 256))
    )
    ...
    # ------------------------------------------------------------------------
    ventricle_numbers = (
        left_ventricle_numbers + right_ventricle_numbers + medial_ventricle_numbers
    )
    ventricle_names = (
        left_ventricle_names + right_ventricle_names + medial_ventricle_names
    )
    ventricle_colors = (
        left_ventricle_colors + right_ventricle_colors + medial_ventricle_colors
    )

    cerebrum_cortex_DKT31_numbers = (
        left_cerebrum_cortex_DKT31_numbers + right_cerebrum_cortex_DKT31_numbers
    )
    cerebrum_cortex_DKT31_names = (
        left_cerebrum_cortex_DKT31_names + right_cerebrum_cortex_DKT31_names
    )
    cerebrum_cortex_DKT31_colors = (
        left_cerebrum_cortex_DKT31_colors + right_cerebrum_cortex_DKT31_colors
    )
    cerebrum_cortex_numbers = (
        left_cerebrum_cortex_numbers + right_cerebrum_cortex_numbers
    )
    cerebrum_cortex_names = left_cerebrum_cortex_names + right_cerebrum_cortex_names
    cerebrum_cortex_colors = left_cerebrum_cortex_colors + right_cerebrum_cortex_colors
    ...
    left_cerebrum_names = left_cerebrum_cortex_names + left_cerebrum_noncortex_names
    left_cerebrum_colors = left_cerebrum_cortex_colors + left_cerebrum_noncortex_colors
    right_cerebrum_numbers = (
        right_cerebrum_cortex_numbers + right_cerebrum_noncortex_numbers
    )
    right_cerebrum_names = right_cerebrum_cortex_names + right_cerebrum_noncortex_names
    right_cerebrum_colors = (
        right_cerebrum_cortex_colors + right_cerebrum_noncortex_colors
    )
    ...
    left_cerebellum_numbers = (
        left_cerebellum_cortex_numbers + left_cerebellum_noncortex_numbers
    )
    left_cerebellum_names = (
        left_cerebellum_cortex_names + left_cerebellum_noncortex_names
    )
    right_cerebellum_numbers = (
        right_cerebellum_cortex_numbers + right_cerebellum_noncortex_numbers
    )
    right_cerebellum_names = (
        right_cerebellum_cortex_names + right_cerebellum_noncortex_names
    )

    cerebellum_cortex_numbers = (
        left_cerebellum_cortex_numbers + right_cerebellum_cortex_numbers
    )
    cerebellum_cortex_names = (
        left_cerebellum_cortex_names + right_cerebellum_cortex_names
    )
    cerebellum_cortex_colors = (
        left_cerebellum_cortex_colors + right_cerebellum_cortex_colors
    )
    ...
    cerebellum_noncortex_colors = (
        left_cerebellum_noncortex_colors + right_cerebellum_noncortex_colors
    )
    cerebellum_numbers = cerebellum_cortex_numbers + cerebellum_noncortex_numbers
    ...
    label_numbers = (
        cerebrum_numbers + cerebellum_numbers + brainstem_numbers + extra_numbers
    )
    label_names = cerebrum_names + cerebellum_names + brainstem_names + extra_names
    label_colors = cerebrum_colors + cerebellum_colors + brainstem_colors + extra_colors
    ...
    for i, x in enumerate(label_colors):
        ...
        colormap_normalized.append(
            [label_numbers[i], 1, x[0] / 255.0, x[1] / 255.0, x[2] / 255.0]
        )
